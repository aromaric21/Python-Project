...
entryField = customtkinter.CTkEntry(root, font=('arial', 20, 'bold'), text_color='white',
                                    fg_color='black', border_color='white', width=280,
                                    height=50, bg_color='black')
...
bplus = customtkinter.CTkButton(root, text='+', font=('arial', 20, 'bold'), width=60, bg_color='black', cursor='hand2', fg_color='orange', command=lambda: click('+'))
...
bsub = customtkinter.CTkButton(root, text='-', font=('arial', 20, 'bold'), width=60, bg_color='black', cursor='hand2', fg_color='orange', hover_color='orange3', command=lambda: click('-'))
...
bmultiply = customtkinter.CTkButton(root, text='*', font=('arial', 20, 'bold'), width=60, bg_color='black', cursor='hand2', fg_color='orange', command=lambda: click('*'))
...
bdivision = customtkinter.CTkButton(root, text='/', font=('arial', 20, 'bold'), width=60, bg_color='black', cursor='hand2', fg_color='orange', hover_color='orange3', command=lambda: click('/'))
bdivision.grid(row=4, column=3)

bequal= customtkinter.CTkButton(root, text='=', font=('arial', 20, 'bold'), width=280, bg_color='black', cursor='hand2', fg_color='green', hover_color='dark green', command=answer)
